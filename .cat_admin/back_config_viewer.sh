#!/usr/bin/env bash
# back_config_viewer.sh
# Dialog-based viewer for backup configs in /var/lib/tftpboot/cat
# - Lists *.cfg files with a compact menu
